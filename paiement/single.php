...
llxHeader('', $title='Paiement', 'Paiement', '', 0, 0, '', '','', '');
include '../header.php';
?>
    ...
    <div ng-app="singleApp" ng-controller="singleCtrl" ng-cloak>
                ...
                <div style="vertical-align: middle">
                    ...
                    <div class="pagination">
                        ...
                        <ul>
                            ...
                            <li class="noborder litext"><a href="/htdocs/syndic/paiement/liste.php">Retour liste</a></li>
                    ...
                    <div class="inline-block floatleft valignmiddle refid refidpadding" style="text-transform: capitalize;">
                        ...
                        {{num_paiement}} {{date_paiement}}
                        <input type="hidden" value="{{id}}">

                        <div class="refidno">{{montant_paiement}} DH</div>
                ...
                <div class="fichehalfleft">
                    ...
                    <table class="border tableforfield" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="nowrap"><b>Num paiement</b></td>
                        ...
                        <tr>
                            ...
                            <td class="nowrap"><b>Date paiement</b></td>
                        ...
                        <tr>
                            ...
                            <td class="nowrap"><b>Mode paiement</b></td>
                        ...
                        <tr>
                            ...
                            <td class="nowrap"><b>Affectation paiement</b></td>

                            <td>{{affectation_paiement}}</td>

                        </tr>

                        <tr>

                            <td class="nowrap"><b>Montant paiement</b></td>

                            <td>{{montant_paiement}} DH</td>
                        ...
                        <tr>
                            <td class="nowrap"><b>Date reçus</b></td>
                            <td>{{date_recu}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Charge reçus</b></td>
                            <td>{{charge_recu}}</td>
                        </tr>
        ...
        <div class="tabsAction">
            ...
            <div class="inline-block divButAction"><a class="butAction" href="/htdocs/syndic/paiement/maj.php?id={{id}}">Modifier</a></div>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">Suppression d'un paiement</h5>
