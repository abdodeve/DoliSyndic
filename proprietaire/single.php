            ...
            <div class="arearef heightref valignmiddle" width="100%">
                ...
                <div style="vertical-align: middle">
                    <div class="pagination">
                        <ul>
                            <li class="noborder litext"><a href="/htdocs/syndic/proprietaire/liste.php">Retour liste</a></li>
...
<!--                    <input type="hidden" value="{{id}}">-->
            ...
            <div class="fichecenter">
                <div class="fichehalfleft">
                    ...
                    <table class="border tableforfield" width="100%">
                        <tbody>
                        <tr>
                            <td class="nowrap"><b>Nom</b></td>
                            <td>{{nom}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Prenom</b></td>
                            <td>{{prenom}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Titre</b></td>
                            <td>{{titre}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Civilite</b></td>
                            <td>{{civilite}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="nowrap"><b>Adresse 1</b></td>
                            <td>{{adresse_1}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Adresse 2</b></td>
                            <td>{{adresse_2}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Email 1</b></td>
                            <td>{{email_1}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Email 2</b></td>
                            <td>{{email_2}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Tel 1</b></td>
                            <td>{{tel_1}}</td>
                        </tr>
                        <tr>
                            <td class="nowrap"><b>Tel 2</b></td>
                            <td>{{tel_2}}</td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <div class="tabsAction">
            <div class="inline-block divButAction"><a class="butAction" href="/htdocs/syndic/proprietaire/maj.php?id={{id}}">Modifier</a></div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Suppression d'un proprietaire</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        Êtes-vous sûr de vouloir supprimer ce proprietaire ?
                    </div>
